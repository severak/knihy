...
\startstandardmakeup
\externalfigure[down][method=png]

{\rm \sc Mikoláš Štrajt}

\title{Trojtečky...}

{\rm \sc edice Pantograf}
\stopstandardmakeup
\page
...
Áňa Kellerová ztratila pas. To se tak občas stává, problém byl v tom že ho ztratila na cestách. A to by se lidem stávat nemělo.
